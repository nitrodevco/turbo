...
namespace Turbo.Database.Migrations
{
    ...
    [Migration("20210330221123_PermissionsEnumFix")]
    partial class PermissionsEnumFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Players.PlayerEntity", b =>
                {
                    ...
                    b.Property<int?>("RankEntityId")
                        .HasColumnType("int")
                        .HasColumnName("rank");

                    b.HasKey("Id");

                    b.HasIndex("RankEntityId");
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Security.PermissionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Security.PlayerPermissionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("RequiredRights")
                        .HasColumnType("int")
                        .HasColumnName("required_rights");
                    ...
                    b.ToTable("player_permissions");
                });

            modelBuilder.Entity("Turbo.Database.Entities.Security.RankEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Security.RankPermissionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Players.PlayerEntity", b =>
                {
                    b.HasOne("Turbo.Database.Entities.Security.RankEntity", "Rank")
                        .WithMany()
                        .HasForeignKey("RankEntityId");
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Security.PlayerPermissionEntity", b =>
                {
                    b.HasOne("Turbo.Database.Entities.Security.PermissionEntity", "PermissionEntity")
                        .WithMany("PlayerPermissions")
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Security.RankPermissionEntity", b =>
                {
                    b.HasOne("Turbo.Database.Entities.Security.PermissionEntity", "PermissionEntity")
                        .WithMany("RankPermissions")
                        .HasForeignKey("PermissionEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Turbo.Database.Entities.Security.RankEntity", "RankEntity")
                        .WithMany("RankPermissions")
                        .HasForeignKey("RankEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Turbo.Database.Entities.Players.PlayerEntity", b =>
                {
                    b.Navigation("PlayerPermissions");
